...
app.put('/image', auth.requireAuth, (req, res) => {imageIncrease.handleImageIncrease(req, res, pg)});

app.post('/image', auth.requireAuth, (req, res) => {imageIncrease.getFaceRecognitionObject(req, res)});
